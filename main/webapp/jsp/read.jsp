...
<head>
    ...
    <script src="js/readFromJson2.js"></script>
</head>
<body>
<header>
...
<table id ="main_table" class="table w-50 shadow rounded text-center position-absolute top-50 start-50 translate-middle">
